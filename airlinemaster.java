...
import java.sql.*;
public class airlinemaster extends JPanel implements ActionListener
{
        JLabel lbid,lbairlinecode,lbairlinename,lbidshow;
        JTextField txtairlinecode,txtairlinename;
        ...
        airlinemaster()
        {
                ...
                lbairlinename=new JLabel("Airline Name");
                lbidshow=new JLabel("");
                txtairlinecode=new JTextField("");
                ...
                pn.add(txtairlinecode);
                pn.add(lbairlinecode);
                pn.add(txtairlinecode);
                pn.add(lbairlinename);
                pn.add(txtairlinename);
                ps.add(btnadd);
                ps.add(btnsave);
                ps.add(btnnext);
                ps.add(btnprevious);
        ...
        void fillrecord()
        {
                try
                {
                        String s="select * from airlinemaster";
        ...
        void showrecord()
        {
                try
                {
                        ...
                        txtairlinecode.setText(rs.getString("airlinecode"));
                        txtairlinename.setText(rs.getString("airlinename"));
                }
                catch(Exception e)
                {
                        JOptionPane.showMessageDialog(this,e.toString(),"airline",0);
        ...
        void saverecord()
        {
                try
                {
                        String cc=txtairlinecode.getText();
                        String cn=txtairlinename.getText();
                        String s="insert into airlinemaster(airlinecode,airlinename)values('"+cc+"','"+cn+"')";
                        st.executeUpdate(s);
        ...
        void updaterecord()
        {
                try
                {
                        ...
                        String cc=txtairlinecode.getText();
                        String cn=txtairlinename.getText();
                        String s="update airlinemaster set airlinecode='"+cc+"',airlinename='"+cn+"'where id="+id;
                        st.executeUpdate(s);
        ...
        void deleterecord()
        {
                try
                {
                        ...
                        {
                                int id=Integer.parseInt(lbidshow.getText());
                                String s="delete from airlinemaster where id="+id;
                                st.executeUpdate(s);
                                fillrecord();
                                rs.next();
                                showrecord();
