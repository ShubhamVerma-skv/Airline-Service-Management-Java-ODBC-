...
import java.sql.*;
public class daymaster extends JPanel implements ActionListener
{
        JLabel lbid,lbdaycode,lbdayname,lbidshow;
        JTextField txtdaycode,txtdayname;
        ...
        daymaster()
        {
                ...
                lbdayname=new JLabel("Day Name");
                lbidshow=new JLabel("");
                txtdaycode=new JTextField("");
        ...
        void fillrecord()
        {
                try
                {
                        String s="select * from daymaster";
        ...
        void showrecord()
        {
                try
                {
                        ...
                        txtdaycode.setText(rs.getString("daycode"));
                        txtdayname.setText(rs.getString("dayname"));
                }
                catch(Exception e)
                {
                        JOptionPane.showMessageDialog(this,e.toString(),"airline",0);
        ...
        void saverecord()
        {
                try
                {
                        String cc=txtdaycode.getText();
                        String cn=txtdayname.getText();
                        String s="insert into daymaster(daycode,dayname)values('"+cc+"','"+cn+"')";
                        st.executeUpdate(s);
        ...
        void updaterecord()
        {
                try
                {
                        ...
                        String cc=txtdaycode.getText();
                        String cn=txtdayname.getText();
                        String s="update daymaster set daycode='"+cc+"',dayname='"+cn+"'where id="+id;
                        st.executeUpdate(s);
        ...
        void deleterecord()
        {
                try
                {
                        ...
                        {
                                int id=Integer.parseInt(lbidshow.getText());
                                String s="delete from daymaster where id="+id;
                                st.executeUpdate(s);
                                fillrecord();
                                rs.next();
                                showrecord();
